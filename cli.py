...
示例：
    ...
    python cli.py alerts --severity ERROR --limit 20
    python cli.py alerts --step 1200
    python cli.py stats --step 100
    python cli.py stats --step 100 --phase backward --layer encoder.layer.0
    python cli.py --db ./my_run/metrics.db summary
"""
